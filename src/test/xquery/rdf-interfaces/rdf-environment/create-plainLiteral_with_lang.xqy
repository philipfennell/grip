...
return
	deep-equal(rdfenv:create-literal('Harry Potter and the Philosopher''s Stone', 'en-GB'), <plainLiteral xml:lang="en-GB">Harry Potter and the Philosopher's Stone</plainLiteral>)
