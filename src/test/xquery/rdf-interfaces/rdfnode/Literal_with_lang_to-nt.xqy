...
let $expectedResult as xs:string := '"Harry Potter and the Order of the Phoenix"@en-GB'

return
	rdfnode:to-nt(<plainLiteral xml:lang="en-GB">Harry Potter and the Order of the Phoenix</plainLiteral>) eq $expectedResult