...
let $expectedResult as xs:string := '2001-11-04'

return
	rdfnode:to-string(<typedLiteral datatype="http://www.w3.org/2001/XMLSchema#date">2001-11-04</typedLiteral>) eq $expectedResult