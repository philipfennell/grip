...
let $expectedResult as xs:string := 'Harry Potter and the Order of the Phoenix'

return
	rdfnode:to-string(<plainLiteral>Harry Potter and the Order of the Phoenix</plainLiteral>) eq $expectedResult