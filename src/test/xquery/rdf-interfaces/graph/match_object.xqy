...
return
	graph:match($graph, (), (), <plainLiteral xml:lang="en-GB">Harry Potter and the Philosopher's Stone</plainLiteral>)/triple/*[3]/text() eq 'Harry Potter and the Philosopher''s Stone'
