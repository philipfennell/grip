...
return
	graph:match($graph, <uri>http://example.org/book/book1</uri>, <uri>http://purl.org/dc/elements/1.1/title</uri>, <plainLiteral xml:lang="en-GB">Harry Potter and the Philosopher's Stone</plainLiteral>)
